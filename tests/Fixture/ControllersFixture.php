...
class ControllersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'controllerName' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'controllerName' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
